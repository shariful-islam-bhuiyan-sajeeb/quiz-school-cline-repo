...
const Footer = () => {
    return (
        <div>
            <footer className="py-4 divide-y bg-black text-white">
                    ...
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-violet-400">
                                <img className='rounded-full' src="https://png.pngtree.com/png-vector/20210326/ourmid/pngtree-quiz-icon-with-chronometer-png-image_3123223.jpg" alt="" />
                            </div>
                            <span className="self-center text-2xl font-semibold">Quiz School</span>
                        </a>
                    </div>
                ...
                <div className="py-6 text-sm text-center text-white">© Programming Hero student.</div>
            </footer>
        </div>
    );
};
